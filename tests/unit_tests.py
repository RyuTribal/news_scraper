# -*- coding: utf-8 -*-
"""
All unit tests for the news_scraper library should be contained in this file.
"""
import sys
import os
import unittest
...
# news_scraper's unit tests are in their own separate module, so
...
import news_scraper
from news_scraper import Article, fulltext, Source, ArticleException, news_pool
from news_scraper.article import ArticleDownloadState
from news_scraper.configuration import Configuration
from news_scraper.urls import get_domain
...
class ContentExtractorTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.extractor = news_scraper.extractors.ContentExtractor(Configuration())
        self.parser = news_scraper.parsers.Parser
...
class UrlTestCase(unittest.TestCase):
    ...
    def test_pubdate(self):
        ...
        from news_scraper.urls import STRICT_DATE_REGEX
    ...
    def test_prepare_url(self):
        ...
        """
        from news_scraper.urls import prepare_url
...
class MThreadingTestCase(unittest.TestCase):
    ...
    def test_download_works(self):
        ...
        slate_paper = news_scraper.build('http://slate.com', config=config)
        tc_paper = news_scraper.build('http://techcrunch.com', config=config)
        espn_paper = news_scraper.build('http://espn.com', config=config)
...
class Testnews_scraperLanguagesApi(unittest.TestCase):
    @print_test
    def test_languages_api_call(self):
        news_scraper.languages()
